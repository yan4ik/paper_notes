...
[image2]: ./img/defence_triplet_all_batch.png
...
Selected triplets can be considered moderate triplets, since they are the hardest within a small subset of the data.

### Batch All

Another alternative, that is to simply use all possible combinations of triplets, which we call `Batch All`:
